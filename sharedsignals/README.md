# OpenID Foundation Shared Signals WG proposed publications 

Files proposed by Shared Signals draft editors should be added into this sub-directory via a branch that follows the pattern...
    propose/**
