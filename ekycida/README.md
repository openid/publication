# OpenID Foundation eKYC & IDA WG proposed publications 

Files proposed by eKYC & IDA draft editors should be added into this sub-directory via a branch that follows the pattern...
    propose/**
