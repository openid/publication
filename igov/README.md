# OpenID Foundation IPSIE WG proposed publications 

Files proposed by IGOV Working Group draft editors should be added into this sub-directory via a branch that follows the pattern...
    propose/**
